...
object IntegrationTestProjectConfiguration : AbstractProjectConfig() {

    override val isolationMode = SingleInstance
    override val parallelism: Int = 1

    object IntegrationTestExtension : BeforeProjectListener {
        override suspend fun beforeProject() = TimeZone.setDefault(TimeZone.getTimeZone(UTC))
    }

    override fun extensions() = listOf(SpringExtension, IntegrationTestExtension)
}

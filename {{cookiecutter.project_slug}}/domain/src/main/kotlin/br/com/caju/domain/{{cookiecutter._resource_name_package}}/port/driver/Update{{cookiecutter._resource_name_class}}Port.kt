...
fun interface Update{{cookiecutter._resource_name_class}}Port {
    suspend operator fun invoke(command: Update{{cookiecutter._resource_name_class}}Command): {{cookiecutter._resource_name_class}}
}
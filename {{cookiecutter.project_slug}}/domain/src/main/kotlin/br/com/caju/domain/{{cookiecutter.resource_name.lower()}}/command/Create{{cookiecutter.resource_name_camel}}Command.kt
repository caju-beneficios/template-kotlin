...
data class Create{{cookiecutter.resource_name_camel}}Command({% if cookiecutter.resource_name == 'Article' %}
    val title: String,
    val content: String,
    val status: String
...
fun Create{{cookiecutter.resource_name_camel}}Command.toModel(id: UUID) = {{cookiecutter.resource_name_camel}}(

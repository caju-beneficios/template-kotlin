...
data class Update{{cookiecutter.resource_name_class}}Command(
    val id: UUID,
...
fun Update{{cookiecutter.resource_name_class}}Command.toModel() = {{cookiecutter.resource_name_class}}(
    id = id,
{% if cookiecutter.resource_name == 'Article' %}
    title = title,
    content = content,
...
{% endif %}
    createdAt = null, // Will be set by persistence layer

package br.com.caju.domain.{{cookiecutter.resource_name_lower}}.port.driven{% if cookiecutter.include_kafka_events == 'y' %}
...
interface {{cookiecutter.resource_name.capitalize()}}EventProducerPort {
    suspend fun notifyMessage({{cookiecutter.resource_name_lower}}: {{cookiecutter.resource_name.capitalize()}}, {{cookiecutter.resource_name_lower}}EventType: {{cookiecutter.resource_name.capitalize()}}EventType)
}{% else %}

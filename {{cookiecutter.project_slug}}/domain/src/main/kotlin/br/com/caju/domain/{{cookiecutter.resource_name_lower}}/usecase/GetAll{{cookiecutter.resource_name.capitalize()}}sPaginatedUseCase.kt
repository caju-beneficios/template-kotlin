...
{% if cookiecutter.include_pagination == 'y' %}import br.com.caju.domain.{{cookiecutter.resource_name_lower}}.model.{{cookiecutter.resource_name.capitalize()}}
...
import br.com.caju.domain.{{cookiecutter.resource_name_lower}}.port.driver.GetAll{{cookiecutter.resource_name.capitalize()}}sPaginatedPort
...
@Service
class GetAll{{cookiecutter.resource_name.capitalize()}}sPaginatedUseCase(private val {{cookiecutter.resource_name_lower}}DataAccessPort: {{cookiecutter.resource_name.capitalize()}}DataAccessPort) :

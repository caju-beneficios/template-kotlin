...
data class {{cookiecutter._resource_name_class}}RequestDTO({% if cookiecutter.resource_name == 'Article' %}
    val title: String,
    val content: String,
    val status: String
...
fun {{cookiecutter._resource_name_class}}RequestDTO.toCreateCommand() = Create{{cookiecutter._resource_name_class}}Command({% if cookiecutter.resource_name == 'Article' %}
    title = title,
    content = content,
    status = status
...
fun {{cookiecutter._resource_name_class}}RequestDTO.toUpdateCommand(id: UUID) = Update{{cookiecutter._resource_name_class}}Command(

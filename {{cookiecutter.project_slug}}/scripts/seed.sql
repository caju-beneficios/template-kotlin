...
-- Sample Articles
INSERT INTO {{cookiecutter.resource_name_lower}} (id, version, title, content, status, created_at, modified_at)
VALUES
...
{% else %}
-- TODO: Add seed data for {{cookiecutter.resource_name_lower}} entity
-- INSERT INTO {{cookiecutter.resource_name_lower}} (id, version, created_at, modified_at)
-- VALUES
--     (uuid_generate_v4(), 0, NOW(), NOW())
-- ON CONFLICT (id) DO NOTHING;

SELECT 'Seed data template ready for {{cookiecutter.resource_name_lower}}' as status;
{% endif %}